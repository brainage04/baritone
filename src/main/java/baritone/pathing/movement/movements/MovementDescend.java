...
public class MovementDescend extends Movement {
    ...
    public MovementState updateState(MovementState state) {
        ...
        state.setInput(Input.SNEAK, Baritone.settings().allowSneakOnMagmaBlocks.value && BlockStateInterface.get(ctx, ctx.player().blockPosition().below()).getBlock().equals(Blocks.MAGMA_BLOCK));
